...
$strsqls="select * from ".TABLEPRE."witkey_feed where uid=".$gUid." and  feedtype in (".$strArr.")  order by feed_time desc limit 0,5";
...
$strTaskSql = "SELECT task_id, model_id, task_title, task_cash, task_cash_coverage, start_time, task_status FROM `"
    ...
    .TABLEPRE."witkey_task_bid WHERE uid = ".$gUid." ) OR task_id IN ( SELECT task_id FROM "
    .TABLEPRE."witkey_task_work WHERE uid = ".$gUid." ) )";
