<?php keke_tpl_class::checkrefresh('admin/tpl/admin_config_pay', '1457950487' );?><!DOCTYPE HTML>
...
<div class="box list">
 <div class="title"><h2><?php echo $_lang['pay_interface'];?>&nbsp&nbsp</h2></div>
  <div class="detail">
...
<?php } elseif($v['pay_dir']=='wxpay') { ?>
<a href="https://pay.weixin.qq.com" class="button"><span class="user icon"></span><?php echo $_lang['application_interface'];?></a>	
...
<div class="box list">
 <div class="title"><h2><?php echo $_lang['line_pay_interface'];?>&nbsp&nbsp</h2></div>
  <div class="detail">
     <form action="" method="post">
     	<input type="hidden" value="<?php echo $do?>" name="do">
<input type="hidden" value="<?php echo $view?>" name="view">
