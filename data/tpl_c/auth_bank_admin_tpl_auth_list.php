<?php keke_tpl_class::checkrefresh('auth/bank/admin/tpl/auth_list', '1457949931' );?><!DOCTYPE HTML>
...
<div class="page_title"><h1><?php echo $_lang['bank_auth_list'];?></h1></div>
<!--页头结束-->
...
<td><input type="text" class="txt" name="w[bank_a_id]" 	value="<?php echo $w['bank_a_id'];?>" onkeyup="clearstr(this);"></td>
...
<!--搜索结束-->
<div class="box list">
    	<div class="title"><h2><?php echo $_lang['bank_auth_list'];?></h2></div>
        <div class="detail">
...
<!--<th><?php echo $_lang['operate'];?></th>-->
  ...
  <?php if(is_array($bank_arr)) { foreach($bank_arr as $v) { ?>
<tr class="item">
<td><input type="checkbox" name="ckb[]" id="cbk_selected" value="<?php echo $v['bank_a_id'];?>"></td>
<td><?php echo $v['bank_a_id'];?></td>
...
<?php } ?>
<a href="index.php?do=<?php echo $do;?>&view=info&code=<?php echo $code?>&bank_a_id=<?php echo $v['bank_a_id'];?>" class="button dbl_target"><span class="book icon"></span><?php echo $_lang['view'];?></a>
<!--
<?php if($v['auth_status']==0) { ?>
<a  href="index.php?do=<?php echo $do;?>&view=<?php echo $view;?>&code=<?php echo $code?>&ac=not_pass&bank_a_id=<?php echo $v['bank_a_id']?>&obj=<?php echo $v['username']?>" class="button" onclick="return cdel(this,'<?php echo $_lang['confirm_nopass'];?>')"><span class="cross icon"></span><?php echo $_lang['nopass'];?></a>
<?php } ?>-->
<?php if($v['auth_status']!=1) { ?>
<a href="index.php?do=<?php echo $do;?>&view=<?php echo $view;?>&code=<?php echo $code?>&ac=del&bank_a_id=<?php echo $v['bank_a_id']?>&obj=<?php echo $v['username']?>" onclick="return cdel(this);" class="button"><span class="trash icon"></span><?php echo $_lang['delete'];?></a>
<?php } ?>
</div>
</td>
