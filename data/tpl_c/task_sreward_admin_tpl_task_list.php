<?php keke_tpl_class::checkrefresh('task/sreward/admin/tpl/task_list', '1457949992' );?><!DOCTYPE HTML>
...
<th width="10%"><?php echo $_lang['task_status'];?></th>
                  ...
                  <tr class="item">
                    ...
                    <td class="td28">
                    	<a href="../index.php?do=task&id=<?php echo $v['task_id'];?>" target="_blank"><?php echo kekezu::cutstr($v['task_title'],40) ?></a>
...
<!-- <a href="index.php?do=model&model_id=<?php echo $v['model_id']?>&view=list&task_id=<?php echo $v['task_id']?>&ac=nopass&page=<?php echo $page;?>" onclick="return cpass(this,'',2);" class="button"><span class="cross icon"></span>11审核失败</a> -->
...
art.dialog.open('index.php?do=model&model_id=1&view=list&ac=settask&task_id='+task_id,{
title:"请输入结束任务原因",
height:260,
width:450,
closeFn:function (){
...
if(ispass=='ok'){
art.dialog.data('ispass','no');
window.location="index.php?do=model&model_id=1&view=list&ac=stoptask&content="+content+"&task_id="+task_id;
}
}
},false);
}
