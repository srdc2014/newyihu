<?php keke_tpl_class::checkrefresh('shop/service/admin/tpl/service_order', '1457949986' );?><!DOCTYPE HTML>
...
<div class="page_title">
    	<h1><?php echo $_lang['service_order_manage'];?></h1>
        <div class="tool">   
 	<a href="index.php?do=<?php echo $do;?>&model_id=<?php echo $model_id;?>&view=order" class="here" ><?php echo $_lang['order_list'];?></a>
...
<input type="hidden" name="page" value="<?php echo $page;?>">
        		<table cellspacing="0" cellpadding="0">
        			<tr> 
            			<th width="10%"><input type="checkbox" id="checkbox" onclick="checkall();" class="checkbox" >编号</th>
    ...
    <th width="20%"><?php echo $_lang['order_time'];?></th>
                	...
                	<tr class="item">
                    	...
                    	<td>
                    		<?php echo $arrStatus[$v['order_status']];?>
</td>
<td>
                    ...
                    <tr>
        				<td colspan="9">
                			...
                			<div class="clearfix">
                    			...
                    			<button class="pill negative" type="submit" value="<?php echo $_lang['mulit_delete'];?>" name="sbt_action" onclick="return batch_act(this,'frm_art_search1');"><span class="icon trash">&nbsp;</span><?php echo $_lang['mulit_delete'];?></button>
                			</div>
             			</td>
    			   </tr>
        		</table></div>
