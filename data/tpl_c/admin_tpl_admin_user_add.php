<?php keke_tpl_class::checkrefresh('admin/tpl/admin_user_add', '1457949911' );?><!DOCTYPE HTML>
 ...
 <?php } ?>
  ...
  <tr>
                       <th scope="row"><?php echo $_lang['email'];?><?php echo $_lang['zh_mh'];?></th>
                        <td> <input type="text" class="txt" style="width:260px;" name="fds[email]" id="email"limit="required:true;type:email" value="<?php echo $member_arr['email'];?>" msg="<?php echo $_lang['format_error'];?>" title="<?php echo $_lang['please_input_right_email'];?>..."  ajax="index.php?do=user&view=add&edituid=<?php echo $edituid?>&check_email="  msgArea="txt_email_msg"/><b style="color:red"> *</b><span id="txt_email_msg"></span></td>
                      </tr>
