<?php keke_tpl_class::checkrefresh('task/mreward/admin/tpl/task_config', '1457949997' );?><!DOCTYPE HTML>
...
<!-- <tr>
 ...
 <tr>
    <th scope="row" width="200"><?php echo $_lang['model_description'];?><?php echo $_lang['zh_mh'];?></th>
      <td>
        <textarea cols=110 name="fds[model_desc]"   id="tar_content"  ><?php echo $model_info['model_desc']?></textarea>
  </td>
...
k = eval(i + 1);
var rul_option ='<li><?php echo $_lang['di'];?><input type="text" class="txt" size="10" name="txt_defer_times_'+k+'" value="'+k+'" readonly="true" class="input_t"/><?php echo $_lang['times'];?><?php echo $_lang['no_less_than_reward_total'];?><input type="text" size="10" class="txt"  limit="type:float;required:true" msg="<?php echo $_lang['percent_not_null'];?>" name="txt_defer_cash_scale_'+k+'" class="input_t">%</li>';
