<?php keke_tpl_class::checkrefresh('task/match/admin/tpl/task_list', '1457950016' );?><!DOCTYPE HTML>
...
<div class="page_title">
    	<h1><?php echo $model_info['model_name'];?><?php echo $_lang['manage'];?></h1>
         <div class="tool">
         	<a href="index.php?do=model&model_id=12&view=list&status=0" class="here"><?php echo $_lang['task_list'];?></a>
...
<input type="checkbox" id="checkbox" onclick="checkall();" class="checkbox" >编号
                    ...
                    <th width="23%"><?php echo $_lang['task_title'];?></th>
<th width="18%"><?php echo $_lang['task_cash'];?></th>
<th width="10%"><?php echo $_lang['pub_name'];?></th>
    <th width="13%"><?php echo $_lang['task_status'];?></th>
...
<?php if($v['is_top']==1) { ?><font color="red"><?php echo $_lang['recommended'];?></font><?php } ?>
                    ...
                    <td><?php  echo keke_curren_class::output(floatval($cash_rule_arr[$v[task_cash_coverage]][start_cove]),-1);  ?>-<?php  echo keke_curren_class::output(floatval($cash_rule_arr[$v[task_cash_coverage]][end_cove]),-1);  ?></td>
...
<?php if(in_array($v['task_status'],array(0,8,9))) { ?>
...
<?php } ?>
<?php if($v['task_status']==7) { ?>
<a href="index.php?do=model&model_id=<?php echo $v['model_id']?>&view=deliverfrozen&task_id=<?php echo $v['task_id']?>&page=<?php echo $page;?>" class="button" ><span class="pen icon"></span>处理</a>
<?php } ?>
</td>
                  </tr>
                  <?php } } ?>
...
<?php if($w['task_status']=='0'||$w['task_status']=='1'||$w['task_status']=='8'||$w['task_status']=='9'||$w['task_status']=='10') { ?>
...
<?php } ?>
<?php if($w['task_status']=='1'||$w['task_status']=='0') { ?>
...
<button type="submit" value="<?php echo $_lang['mulit_nopass'];?>" onclick="return batch_act(this,'frm_list');"  class="positive pill negative"><span class="icon check">&nbsp;</span><?php echo $_lang['mulit_nopass'];?></button>
<?php } ?>
