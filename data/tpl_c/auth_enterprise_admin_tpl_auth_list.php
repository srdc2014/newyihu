<?php keke_tpl_class::checkrefresh('auth/enterprise/admin/tpl/auth_list', '1457949933' );?><!DOCTYPE HTML>
...
<div class="page_title"><h1><?php echo $_lang['enterprise_auth_list'];?></h1></div>
<!--页头结束-->
...
<td><input type="text" class="txt" name="w[enterprise_auth_id]" 	value="<?php echo $w['enterprise_auth_id'];?>" onkeyup="clearstr(this);"></td>
...
<div class="box list">
    	<div class="title"><h2><?php echo $_lang['enterprise_auth_list'];?></h2></div>
        <div class="detail">
...
<input type="hidden" value="<?php echo $page;?>" name="page" />
        <table cellspacing="0" cellpadding="0">
         <tbody>
          <tr>
          	<th ><input type="checkbox" id="checkbox" onclick="checkall();"><?php echo $_lang['id'];?></th>

            <th><?php echo $_lang['username'];?></th>
<th><?php echo $_lang['register_num'];?></th>
<th><?php echo $_lang['licence_pic'];?></th>
<!--<th><?php echo $_lang['cash'];?></th>-->
<th><?php echo $_lang['validity'];?></th>
<th><?php echo $_lang['auth_status'];?></th>
<!--<th><?php echo $_lang['operate'];?></th>-->
          </tr>
  <?php if(is_array($enterprise_arr)) { foreach($enterprise_arr as $v) { ?>
<tr class="item">
<td><input type="checkbox" name="ckb[]" id="cbk_selected" value="<?php echo $v['enterprise_auth_id'];?>"><?php echo $v['enterprise_auth_id'];?></td>

<td><?php echo $v['username'];?></td>
<td><?php echo $v['licen_num'];?></td>
<td><a target="_blank" href="../<?php echo $v['licen_pic'];?>"><img src="../<?php echo $v['licen_pic'];?>" width="40" height="40"></a></td>

<!--<td><font color="#ff7700"><?php echo $_lang['free'];?></font></td>-->
...
<?php } ?>
<?php if($v['auth_status']==0||$v['auth_status']==2) { ?>
<a  class="button dbl_target" href="index.php?do=<?php echo $do;?>&view=<?php echo $view;?>&code=<?php echo $code?>&ac=pass&enterprise_auth_id=<?php echo $v['enterprise_auth_id'];?>&obj=<?php echo $v['username']?>" 	onclick="return cdel(this,'<?php echo $_lang['confirm_pass'];?>')"><span class="check icon"></span><?php echo $_lang['pass'];?></a>
<?php } ?>
<?php if($v['auth_status']==0) { ?>
<a  class="button" href=javascript:lookinfo("index.php?do=<?php echo $do;?>&view=<?php echo $view;?>&code=<?php echo $code?>&ac=not_pass&enterprise_auth_id=<?php echo $v['enterprise_auth_id'];?>&obj=<?php echo $v['username']?>&uid=<?php echo $v['uid'];?>"); ><span class="cross icon"></span><?php echo $_lang['nopass'];?></a>
<!-- <a  class="button" href="index.php?do=<?php echo $do;?>&view=<?php echo $view;?>&code=<?php echo $code?>&ac=not_pass&enterprise_auth_id=<?php echo $v['enterprise_auth_id'];?>&obj=<?php echo $v['username']?>" onclick="return cdel(this,'<?php echo $_lang['confirm_nopass'];?>')"><span class="cross icon"></span>11<?php echo $_lang['nopass'];?></a> -->
<?php } ?>
<?php if($v['auth_status']!=1) { ?>
<a class="button" href="index.php?do=<?php echo $do;?>&view=<?php echo $view;?>&code=<?php echo $code?>&ac=del&enterprise_auth_id=<?php echo $v['enterprise_auth_id'];?>&obj=<?php echo $v['username']?>" onclick="return cdel(this)"><span class="trash icon"></span><?php echo $_lang['delete'];?></a>
<?php } ?>
</td>
</tr>
<?php } } ?>
