<?php keke_tpl_class::checkrefresh('task/dtender/admin/tpl/task_config', '1457950013' );?><!DOCTYPE HTML>
...
<label for="satus_no"><input type="radio" id="status_no" name="fds[model_status]" <?php if(!$model_info['model_status']) { ?>checked<?php } ?> value="0"> <?php echo $_lang['no'];?></label>
</td>
        </tr>
<tr>
        </tr>
...
<br class="clear">(<?php echo $_lang['you_can_choose'];?>)
</td>
         </tr>  -->
 ...
 <tr>
    <th scope="row" width="200">模型说明<?php echo $_lang['zh_mh'];?></th>
      <td>
        <textarea   name="fds[model_desc]"  id="tar_content"  cols="70"><?php echo $model_info['model_desc']?></textarea>
  </td>
...
<script type="text/javascript" src="<?php echo $_K['siteurl'];?>/static/js/ueditor/lang/zh-cn/zh-cn.js"></script>
 ...
 <?php if($on_time) { ?>
    <tr>
      <th scope="row" width="200"><?php echo $_lang['last_modified_time'];?><?php echo $_lang['zh_mh'];?></th>
  ...
  <th scope="row" width="200">&nbsp;</th>
    <td>
       <div class="clearfix padt10">
         <button type="submit" name="sbt_edit" class="positive primary pill button" value="1"><span class="check icon"></span><?php echo $_lang['submit'];?></button>
