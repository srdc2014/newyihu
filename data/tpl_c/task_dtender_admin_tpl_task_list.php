<?php keke_tpl_class::checkrefresh('task/dtender/admin/tpl/task_list', '1457950011' );?><!DOCTYPE HTML>
...
<div class="page_title">
    ...
    <div class="tool">
        <a href="index.php?do=model&model_id=<?php echo $model_id;?>&view=list" class="here"><?php echo $_lang['task_list'];?></a>
<!--<a href="index.php?do=model&model_id=<?php echo $model_id;?>&view=config"><?php echo $_lang['task_config'];?></a>-->
    </div>
</div>
<div class="box search p_relative">
    ...
    <div class="detail" id="detail">
        <form action="index.php?do=<?php echo $do;?>&model_id=<?php echo $model_id;?>&view=list" method="post" id=frm_user_search>
        	 ...
        	 <table cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" value="<?php echo $task_id;?>" name="w[task_id]" class="txt" onkeyup="clearstr(this);"/>
                        </td>
                        <th>
                            <?php echo $_lang['task_title'];?>
                        </th>
                        <td>
                            <input type="text" value="<?php echo $task_title;?>" name="w[task_title]" class="txt" /><?php echo $_lang['search_by_like'];?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="ps vm" name="w[task_status]" id="catid" onchange="statusJump(this.value)">
                                ...
                                <?php if(is_array($task_status)) { foreach($task_status as $key => $v) { ?>
                                <?php if($key>=1) { ?>
<option value="<?php echo $key?>" <?php if($w['task_status']==$key) { ?>  selected="selected"<?php } ?>><?php echo $v?>  </option>
                                <?php } ?>
                                <?php } } ?>
                            </select>
                        </td>
                        ...
                        <td>
                           ...
                           <option value="end_time" <?php if($ord['0']=='end_time' ) { ?> selected="selected"<?php } ?>><?php echo $_lang['expiration_time'];?></option>
                      </select>
...
<div class="box list">
    <div class="title">
     ...
     <div class="detail">
        <form action="index.php?do=<?php echo $do;?>&model_id=<?php echo $model_id;?>&view=list" method="post" id="frm_list">
 	<input type="hidden" value="<?php echo $page;?>" name="page">
...
编号
    ...
    <th width="20%">
                     <?php echo $_lang['task_cash'];?>
                       </th>
                           <th width="10%">
                      <?php echo $_lang['pub_name'];?>
                       </th>
                     ...
                     <!--   <th width="14%">
                     <?php echo $_lang['expiration_time'];?>
                        </th>-->
                        <th width="20%">
...
<?php if(!$v['task_cash_coverage']) { ?>
                    		<?php  echo keke_curren_class::output(floatval($v['budget']),-1);  ?>
                    	<?php } else { ?>
                     		<?php  echo keke_curren_class::output(floatval($cash_rule_arr[$v[task_cash_coverage]][start_cove]),-1);  ?>-<?php  echo keke_curren_class::output(floatval($cash_rule_arr[$v[task_cash_coverage]][end_cove]),-1);  ?>
                     	<?php } ?>
                            </td>
                            <td>
                               <?php echo $v['username'];?>
                            ...
                            <td>
                                <?php if($v['task_status']==0) { ?><?php echo $_lang['without_payment'];?><?php } elseif($v['task_status']==1) { ?><?php echo $_lang['pending'];?><?php } elseif($v['task_status']==2) { ?><?php echo $_lang['in_bidding'];?><?php } elseif($v['task_status']==3) { ?><?php echo $_lang['standard_selection_in'];?>
<?php } elseif($v['task_status']==4) { ?><?php echo $_lang['to_be_managed'];?><?php } elseif($v['task_status']==6) { ?><?php echo $_lang['delivery_of'];?><?php } elseif($v['task_status']==7) { ?><?php echo $_lang['freezing_process'];?>
<?php } elseif($v['task_status']==8) { ?><?php echo $_lang['has_ended'];?><?php } elseif($v['task_status']==9) { ?><?php echo $_lang['has_fail'];?><?php } elseif($v['task_status']==10) { ?><?php echo $_lang['nopass'];?>
<?php } elseif($v['task_status']==11) { ?><?php echo $_lang['in_the_arbitration'];?><?php } ?>
                            </td>

                             <td>
                               <!--
                               <?php if($v['task_status']==1||$v['task_status']==0) { ?>
  		<a href="index.php?do=model&model_id=<?php echo $model_id?>&view=list&ac=pass&task_id=<?php echo $v['task_id'];?>&page=<?php echo $page;?>" onclick="return cpass(this,'',1);" class="button"><span class="cog icon"></span>审核通过</a>
      								<a href="index.php?do=model&model_id=<?php echo $model_id?>&view=list&ac=nopass&task_id=<?php echo $v['task_id'];?>&page=<?php echo $page;?>" onclick="return cpass(this,'',2);" class="button"><span class="cross icon"></span>审核失败</a>
<?php } ?>
 -->
                             	<?php if($v['task_status']==1||$v['task_status']==0) { ?>
  		<a href="index.php?do=model&model_id=<?php echo $model_id?>&view=list&ac=pass&task_id=<?php echo $v['task_id'];?>&page=<?php echo $page;?>" onclick="return cpass(this,'',1,<?php echo $v['task_status']?>);" class="button"><span class="cog icon"></span>审核通过</a>
      								...
      								<!-- <a href="index.php?do=model&model_id=<?php echo $model_id?>&view=list&ac=nopass&task_id=<?php echo $v['task_id'];?>&page=<?php echo $page;?>" onclick="return cpass(this,'',2);" class="button"><span class="cross icon"></span>审核失败</a> -->
<?php } ?>
<a href="index.php?do=model&model_id=<?php echo $model_id?>&view=edit&task_id=<?php echo $v['task_id'];?>&page=<?php echo $page;?>" class="button dbl_target"><span class="pen icon"></span>查看</a>
<?php if(in_array($v['task_status'],array('8','9','10'))) { ?>
<a href="index.php?do=model&model_id=<?php echo $model_id?>&view=list&ac=del&task_id=<?php echo $v['task_id'];?>&page=<?php echo $page;?>" onclick="return cdel(this);" class="button"><span class="trash icon"></span><?php echo $_lang['delete'];?></a>
   		 <?php } ?>
...
art.dialog.open('index.php?do=model&model_id=5&view=list&ac=settask&task_id='+task_id,{
title:"请输入结束任务原因",
height:260,
width:450,
closeFn:function (){
...
if(ispass=='ok'){
art.dialog.data('ispass','no');
window.location="index.php?do=model&model_id=5&view=list&ac=stoptask&content="+content+"&task_id="+task_id;
}
}
},false);
}
