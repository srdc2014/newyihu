<?php
keke_lang_class::load_lang_class('hongbao_report_class');
class hongbao_report_class extends keke_report_class {
	public static function get_instance($report_id, $report_info = null, $obj_info = null, $user_info = null, $to_userinfo = null) {
		static $obj = null;
		if ($obj == null) {
			$obj = new hongbao_report_class ( $report_id, $report_info, $obj_info, $user_info, $to_userinfo );
		}
		return $obj;
	}
	public function __construct($report_id, $report_info, $obj_info, $user_info, $to_userinfo) {
		...
		$this->_task_obj = new hongbao_task_class($this->_task_info);
	}
