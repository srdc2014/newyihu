<?php
keke_lang_class::load_lang_class ( 'hongbao_release_class' );
class hongbao_release_class extends keke_task_release_class {
	public static function get_instance($model_id, $pub_mode = 'professional') {
		static $obj = null;
		if ($obj == null) {
			$obj = new hongbao_release_class ( $model_id, $pub_mode );
		}
		return $obj;
	}
	...
	public function priv_init() {
		$priv_arr = hongbao_priv_class::get_priv ( '', $this->_model_id, $this->_user_info, '2' );
