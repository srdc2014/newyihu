...
public static function deleteAccount($uid,$arrSaveinfo){
	db_factory::execute("delete  from ".TABLEPRE."witkey_member_oauth where uid='".intval($uid)."' and source ='".$arrSaveinfo['type']."'");
}
	...
	public static function getOauthType(){
		return array('sina'=>'新浪微博','qq'=>'QQ登陆','ten'=>'腾讯微博','renren'=>'人人网','douban'=>'豆瓣网','wx'=>'微信');
	}
