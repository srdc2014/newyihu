...
if ($sbt_pay_to_user) {
	...
	keke_msg_class::notify_user($bank_info ['uid'],$bank_info['username'],'bank_auth',$_lang['bank_auth_notice'],$v_arr,2);
	$res and kekezu::admin_show_msg ( $_lang['give_cach_success'],$_SERVER['HTTP_REFERER'],'3','','success');
}else{
	$bank_a_id and $bank_info = db_factory::get_one(sprintf(" select a.*,b.bank_full_name,b.real_name,b.company,b.bank_type from %switkey_auth_bank a left join %switkey_member_bank b
